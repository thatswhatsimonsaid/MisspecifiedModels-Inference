SimulationReformatResultsFunction = function(SimulationResultsList){
  ...
  for(i in 1:NCases){
    ...
    # MonteCarloCI_Population[i,6:7] = MonteCarloMean[i,1] + outer(MonteCarloVariance[i,1]/NCases*qnorm(1-alpha/2,0,1), c(-1,1))
    # MonteCarloCI_Conditional[i,6:7] = MonteCarloMean[i,2] + outer(MonteCarloVariance[i,1]/NCases*qnorm(1-alpha/2,0,1), c(-1,1))
