...
NSim = 5000
for(i in 19:20){
SimulationResultsList = SimulationFunction(NSim = NSim, 
                                                ParameterVector = ParameterVector, 
                                                SimulationCase = i, 
                                                VarFixed = NA,
                                                TypeSetting = TypeSetting)
print(paste0("Case: ", i))
print(c(SimulationResultsList$SimCoverageFrequency[1] - SimulationResultsList$SimCoverageFrequency[3],
      SimulationResultsList$SimCoverageFrequency[2] - SimulationResultsList$SimCoverageFrequency[4]))
}
```


```{r}
SimulationResultsList$SimCoverageFrequency
```
