...
cbind(SmallSampleResultsTable[1:16, 1:5], SmallSampleCoverageList[1:16, ]) %>% xtable(digits = 5)
cbind(SmallSampleResultsTable[17:32, 1:5], SmallSampleCoverageList[1:16, ]) %>% xtable(digits = 5)

SmallSampleResultsTable[1:16,1:9] %>% xtable(digits = 5)
# SmallSampleResultsTable[17:32,1:9] %>% xtable(digits = 5)
