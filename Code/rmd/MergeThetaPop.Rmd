...
# ThetaPopList = ThetaPopList %>% mutate(BetaPop = round(ThetaPop,2)) 

# saveRDS(ThetaPopList,paste0(dir,"/data/",TypeSetting,"/EstimatedThetaPop/EstimatedThetaPop.rds"))
readRDS(paste0(dir,"/data/",TypeSetting,"/EstimatedThetaPop/EstimatedThetaPopN50_200.rds")) ->test
```
