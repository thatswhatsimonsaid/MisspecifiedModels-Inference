...
TypeSetting = "Linear"
set.seed(420)
# source("Code/functions/SimData",TypeSetting,".R", local = FALSE)
...
saveRDS(beta_hat_simulation, paste0("data/SimulationCases/",TypeSetting,"/beta_hat_",TypeSetting,"_simulation.rds"))
