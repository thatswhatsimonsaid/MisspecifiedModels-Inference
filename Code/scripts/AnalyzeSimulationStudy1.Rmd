...
MonteCarloVariance = SimulationResultsReformatted$MonteCarloVariance
...
```{r}
for(i in 1:nrow(ConditionalDiscrepancyStratifiedMatrix)){
  print(mean(ConditionalDiscrepancyStratifiedMatrix[i,c(1:4,9:12)]) - mean(ConditionalDiscrepancyStratifiedMatrix[i,c(5:8,13:16)]))
}

print("")
for(i in 1:nrow(PopulationDiscrepancyStratifiedMatrix)){
  print(mean(PopulationDiscrepancyStratifiedMatrix[i,c(1:4,9:12)]) - mean(PopulationDiscrepancyStratifiedMatrix[i,c(5:8,13:16)]))
}
```
