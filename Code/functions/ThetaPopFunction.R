ThetaPopFunction = function(dat, SimulationCase, type){
  ...
  ## Cases 1 - 18 ##
  if(type == "Linear"){if(SimulationCase <= 18){ThetaPop = 1.0}
    if(SimulationCase %in% c(21,22,25,26,29,30)){ThetaPop = 1.0}
    if(SimulationCase %in% c(19,20,27,28)){ThetaPop = 1.5}
    if(SimulationCase %in% c(23,24,31,32)){ThetaPop = 1.6}}else if(type == "Logistic"){
